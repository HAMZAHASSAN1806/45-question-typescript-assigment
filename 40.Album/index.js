"use strict";
// ALBUM
/* Question.40 Album: Write a function called make_album() that builds a Object describing a music album. The function should
...
that allows you to store the number of tracks on an album. If the calling line includes a value
...
let album2 = make_album("Nusrat Fateh Ali Khan", "Greatest Hits");
let album3 = make_album("Arijit Singh", "Tum Hi Ho", 10);
console.log(album1);
console.log(album2);
console.log(album3);
