...
let countriesToVisit:string[] = ["saudi arabia" , "iraq" , "palestine" , "england" , "australia"];
...
console.log("Again Still in Original Order:" , countriesToVisit);

console.log("Reverse Original Order:" , countriesToVisit.reverse());

console.log("Back to Original Order:" , countriesToVisit.reverse());

console.log("Still in Alphabetical Order:" , countriesToVisit.sort());

console.log("Again Reverse Alphabetical order:" , countriesToVisit.sort().reverse());
